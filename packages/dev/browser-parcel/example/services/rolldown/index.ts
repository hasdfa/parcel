...
import type { BundleOptions as BaseBundleOptions, Worker as RawEsbuildWorker } from './worker';
...
export async function initWorker() {
  ...
  return {
    ...
    rolldown__bundle: async (options: BundleOptions) => {
      const result = await worker.rolldown__bundle(options);
